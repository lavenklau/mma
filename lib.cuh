...
__global__ void matrix_mult_selfadjoint_rowmajor(const Scalar* pdata, int nwordvalid, int nwordpitch, int npitch, const WT* weight, Scalar* dst, int ndstwordpitch) {
#if 0
